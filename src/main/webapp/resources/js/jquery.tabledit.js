    ...
    $.fn.Tabledit = function(options) {
        ...
        var Edit = {
            ...
            submit: function(td) {
                ...
                var ajaxResult = ajax(settings.buttons.edit.action, settings.buttons.edit.method);
        ...
        var Delete = {
            ...
            submit: function(td) {
                ...
                // Send AJAX request to server.
                var ajaxResult = ajax(settings.buttons.delete.action, settings.buttons.delete.method);
